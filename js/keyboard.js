...
function getRealOctave(value) {
  ...
  // 129-171 = octava -1 (fila inferior, notas 0-42)
  // 172-215 = octava 0 (fila superior, notas 0-42 + nota 0 adicional)

  if (value >= 129 && value <= 171) return -1;
  if (value >= 172 && value <= 215) return 0;
  return 0;
}
